...
panel_text("ClassHelper v8.3.0","TOP",0,-5)
...
modConditions:SetFont("Interface\\AddOns\\ClassHelper\\Assets\\monaco.ttf",9)
...
f:SetScript("OnEvent",function()
    if not entered_world then
        ...
        if ClassHelper:Load("ModEditor","SyncAcrossAllFrames")=="true"then
            modSelector:SetFont("Interface\\AddOns\\ClassHelper\\Assets\\monaco.ttf",tonumber(ClassHelper:Load("ModEditor","TextSize")))
            modConditions:SetFont("Interface\\AddOns\\ClassHelper\\Assets\\monaco.ttf",tonumber(ClassHelper:Load("ModEditor","TextSize")))
        end
    end
=======
-- Panel and editor
