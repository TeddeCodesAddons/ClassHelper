...
currentProfileBox:SetFont("Interface\\AddOns\\"..(ClassHelper.ADDON_PATH_NAME).."\\Assets\\monaco.ttf",9)
...
f:SetScript("OnEvent",function()
    if ClassHelper:Load("ModEditor","SyncAcrossAllFrames")=="true"then
        currentProfileBox:SetFont("Interface\\AddOns\\"..(ClassHelper.ADDON_PATH_NAME).."\\Assets\\monaco.ttf",tonumber(ClassHelper:Load("ModEditor","TextSize")))
    end
end)