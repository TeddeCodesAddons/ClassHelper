...
local function handle(self,event,...)
    if not entered_world then
        ...
        createSetting("Mod editor show syntax",{"\124cff00ff00Enabled","\124cffff0000Disabled"},{"true","false"},"ModEditor","SyntaxEnabled",20,-100,"TOPLEFT",100,"Toggles syntax check in mod editor.\nKeywords will appear in different colors when enabled.\nEnabling this feature may greatly impact mod editor performance.",function()StaticPopup_Show("CH_CONFIRM_RELOAD_UI")end)
        createSetting("Mod editor advanced syntax",{"\124cff00ff00Enabled","\124cffff0000Disabled"},{"true","false"},"ModEditor","AdvancedSyntax",20,-180,"TOPLEFT",100,"Enables advanced syntax. EX: When typing 'ClassHelper'\nor 'AlertSystem' it will recognize valid functions\ninstead of just the variable ClassHelper.\nThis can be useful in case you make a typo in a ClassHelper function.\nEnabling this feature may impact mod editor performance.",function()StaticPopup_Show("CH_CONFIRM_RELOAD_UI")end)
