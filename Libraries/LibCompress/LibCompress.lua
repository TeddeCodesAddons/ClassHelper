...
local LibCompress = ClassHelper:NewLibrary("LibCompress") -- This line was replaced. Old line was: local LibCompress = LibStub:NewLibrary("LibCompress", 90000 + tonumber(("$Revision: 83 $"):match("%d+")))
